...
const EditPerson = () => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-3xl p-8">
      <h1 className=" text-left text-2xl font-bold text-gray-900 mb-5">Edit Person</h1>
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Project (s)</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Role</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Start Date</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">End Date</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Total LOE</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Action</th>
            </tr>
          </thead>
          <tbody className="bg-white divide-y divide-gray-200">
            <tr>
              <td className="px-4 py-4 whitespace-nowrap">1</td>  
              <td className="px-4 py-4 whitespace-nowrap">Staff Name</td>
              <td className="px-4 py-4 whitespace-nowrap">
                <select className="block w-full px-1 py-2 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 border-none">
              ...
              <td className="px-4 py-4 whitespace-nowrap">2024-03-20</td>
              <td className="px-4 py-4 whitespace-nowrap">2024-12-31</td>
              <td className="px-4 py-4 whitespace-nowrap">4%</td>
              <td className="px-4 py-4 whitespace-nowrap gap-2 flex">
                <button 
                  onClick={() => handleEdit({
                    id: 1,
            ...
            <form className="space-y-4">
              ...
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => setEditingPerson({...editingPerson, startDate: e.target.value})}
                />
              </div>
              ...
              <div>
                ...
                <input 
                  ...
                  max="100"
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                  value={editingPerson.totalLOE}
                  onChange={(e) => setEditingPerson({...editingPerson, totalLOE: e.target.value})}
                />
              </div>
